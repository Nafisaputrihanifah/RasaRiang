...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">RASA RIANG</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Rasa</strong> Riang</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Rasa Riang</h3>
          <h5>Desa Clapar, Kecamatan Bagelen, Kabupaten Purworejo, Jawa Tengah
          <br>Buka Jam <strong>10:37 - 00:00</strong></h5>
        </div>
